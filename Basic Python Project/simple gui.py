...
text_result = tk.Text(root, width=25, height=2, font=("Arial", 24))
text_result.grid(columnspan=4, pady=10)
...
btn_minus.grid(row=3, column=3, padx=5, pady=5)
...
btn_close.grid(row=5, column=2, padx=5, pady=5)
...
# Row 5
btn_clear = tk.Button(root, text="C", command=clear_field, width=11, height=2, font=("Arial", 14))
btn_clear.grid(row=6, column=0, columnspan=2, padx=5, pady=10)

btn_equal = tk.Button(root, text="=", command=evaluate_calculation, width=11, height=2, font=("Arial", 14))
btn_equal.grid(row=6, column=2, columnspan=2, padx=5, pady=10)
